...
export class ApiStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    // ── Lambda factory ────────────────────────────────────────────────────────
    const createFn = (id: string, entry: string, extraEnv?: Record<string, string>) => {
    ...
    addRoute('/links',                            apigwv2.HttpMethod.POST,   createLinkLambda,             jwtAuthorizer)
    addRoute('/links/{slug}',                     apigwv2.HttpMethod.PATCH,  updateLinkLambda,             jwtAuthorizer)
    addRoute('/links/{slug}',                     apigwv2.HttpMethod.DELETE, deleteLinkLambda,             jwtAuthorizer)
    addRoute('/links',                            apigwv2.HttpMethod.DELETE, bulkDeleteLinksLambda,        jwtAuthorizer)
    addRoute('/links/{slug}/clicks',              apigwv2.HttpMethod.GET,    getClicksLambda,              jwtAuthorizer)
    addRoute('/notifications',                    apigwv2.HttpMethod.GET,    getNotificationsLambda,       jwtAuthorizer)
    addRoute('/notifications/{notificationId}',   apigwv2.HttpMethod.PATCH,  updateNotificationLambda,     jwtAuthorizer)
    addRoute('/notifications',                    apigwv2.HttpMethod.PATCH,  updateAllNotificationsLambda, jwtAuthorizer)
    addRoute('/auth/account',                     apigwv2.HttpMethod.DELETE, deleteAccountLambda,          jwtAuthorizer)
